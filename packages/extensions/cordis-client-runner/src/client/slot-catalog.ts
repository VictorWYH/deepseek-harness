...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'The product shell\'s right region: the selected Agent\'s dashboard and Session list.',
    doc: 'The product shell\'s right region: the selected Agent\'s dashboard and\nSession list. Declared by this package\'s `root` entry; the frame\nrenders the built-in dashboard as the fallback while unoccupied.',
    registerOptions: [],
    ownerProps: [
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'root\' (client-ui-dashboard-shell), so it exists while that entry is mounted',
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'dashboard.main\', () => ctx.slots.register(\n      { name: \'dashboard.main\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-dashboard-shell/src/client/contract/slots.ts:32',
  },
  {
    key: 'dashboard.sidebar',
    kind: 'single',
    scope: 'root',
    summary: 'The product shell\'s left rail: the Agent list.',
    doc: 'The product shell\'s left rail: the Agent list. Declared by this\npackage\'s `root` entry (declaring is claiming); the frame renders a\nbuilt-in Agent list as the fallback while no package occupies the seat.',
    registerOptions: [],
    ownerProps: [
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'dashboard.sidebar\', () => ctx.slots.register(\n      { name: \'dashboard.sidebar\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-dashboard-shell/src/client/contract/slots.ts:26',
  },
  {
    key: 'details',
    kind: 'single',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-dashboard-shell DashboardFrame',
