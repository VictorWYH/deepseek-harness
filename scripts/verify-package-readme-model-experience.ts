...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-dashboard-shell': { kind: 'none', reason: 'Browser-side UI plugin layer; renders the read-only session/workspace projections without changing model context.' },
